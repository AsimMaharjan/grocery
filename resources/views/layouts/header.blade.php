...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('venobox/venobox.min.css')}}">
    <link rel="stylesheet" href="{{ asset('slickslider/slick.min.css')}}">
    <link rel="stylesheet" href="{{ asset('niceselect/nice-select.min.css')}}">
        ...
        <div class="container">
            <div class="header-content">
                <div class="header-media-group"><button class="header-user"><img src="images/user.png"
                        ...
                        class="header-src"><i class="fas fa-search"></i></button></div><a href="{{route('products')}}"
                ...
                <div class="header-widget-group"><a href="compare.html" class="header-widget" title="Compare List"><i
                        ...
                        class="header-widget header-cart" title="Cartlist"><i
                            ...
                            price<small>${{Session::get('total')}}</small></span></button></div>
            </div>
        </div>
    </header>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="megamenu-wrap">
                                                    ...
                                                    <ul class="megamenu-list">
                                                        ...
                                                        <li><a href="{{route('products')}}">shop 1 column</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="col-lg-3">
    ...
    <aside class="cart-sidebar">
        ...
        <ul class="cart-list">
            <li class="cart-item">
                ...
                <div class="cart-media"><a href="#"><img src="{{ asset('images/product/'.$product['image'])}}" alt="product"></a><button
                ...
                <div class="cart-info-group">
                    ...
                    <div class="cart-action-group">
                        ...
                        <form method="POST" action="{{ route('edit_product_quantity')}}" id="form{{$product['id']}}"> 
                            @csrf   
                            <button class="action-minus" title="Quantity Minus"><i
                                    class="icofont-minus"></i></button><input class="action-input"
                                title="Quantity Number" type="number" name="quantity" value="{{$product['quantity']}}"><button
                                class="action-plus" title="Quantity Plus"><i class="icofont-plus" 
                                onchange="document.getElementById('form<?php echo $product['id']; ?>').submit();"
                                ></i></button>
        ...
        @if(Session::has('cart'))
            <form class="coupon-form"><input type="text" placeholder="Enter your coupon code"><button
                ...
                href="checkout.html"><span class="checkout-label">Proceed to Checkout</span><span
                    class="checkout-price">${{Session::get('total')}}/span></a>
        @endif
        </div>
    </aside>
