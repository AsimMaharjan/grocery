        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6 col-xl-3">
                    <div class="footer-widget"><a class="footer-logo" href="#"><img src="{{ asset('images/logo.png')}}"
                                alt="logo"></a>
                ...
                <div class="col-12">
                    <div class="footer-bottom">
                        ...
                        <div class="footer-card"><a href="#"><img src="{{ asset('images/payment/jpg/01.jpg')}}" alt="payment"></a><a
                                href="#"><img src="{{ asset('images/payment/jpg/02.jpg')}}" alt="payment"></a><a href="#"><img
                                    src="{{ asset('images/payment/jpg/03.jpg')}}" alt="payment"></a><a href="#"><img
                                    src="{{ asset('images/payment/jpg/04.jpg')}}" alt="payment"></a></div>
                    </div>
                </div>
            </div>
        </div>
    </footer>
    <script src="{{ asset('bootstrap/jquery-1.12.4.min.js')}}"></script>
    <script src="{{ asset('bootstrap/popper.min.js')}}"></script>
    <script src="{{ asset('bootstrap/bootstrap.min.js')}}"></script>
    <script src="{{ asset('countdown/countdown.min.js')}}"></script>
    <script src="{{ asset('niceselect/nice-select.min.js')}}"></script>
