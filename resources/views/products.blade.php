    ...
    <section class="inner-section shop-part">
        <div class="container">
            <div class="row content-reverse">
                <div class="col-lg-3">
                    <div class="shop-widget-promo"><a href="#"><img src="images/promo/shop/01.jpg" alt="promo"></a>
                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="top-filter">
                                ...
                                <div class="filter-action"><a href="shop-3column.html" title="Three Column"><i
                                            ...
                                            class="fas fa-th-large"></i></a><a href="shop-1column.html" class="active"
                        ...
                        <div class="col">
                            ...
                            <div class="product-standard">
                                ...
                                <div class="standard-media"><a class="standard-image" href="product-video.html"><img
                                            src="{{asset('images/product/'.$product->image)}}" alt="product"></a>
                                ...
                                <div class="standard-content">
                                    <h4 class="standard-name"><a href="{{ route('single_product',['id'=>$product->id]) }}">{{$product->name}}</a></h4>
                                    <h5 class="standard-price"><del>$34</del><span>${{$product->price}}<small>/piece</small></span></h5>
                                    <div class="standard-rating"><i class="active icofont-star"></i><i
                                            class="active icofont-star"></i><i class="active icofont-star"></i><i
                                            class="active icofont-star"></i><i class="icofont-star"></i><a
                                            href="product-video.html">(3)</a></div>
                                    <p class="standard-desc">{{$product->description}}</p>
                                    ...
                                    <form method="POST" action="{{route('add_to_cart')}}">
                                        ...
                                        <input type="submit" name="add_to_cart" class="product-add" value="Add to Cart">
                                    </form>
                                        <div class="product-action"><button class="action-minus"
                                                ...
                                                value="1"><button class="action-plus" title="Quantity Plus"><i
                                                    class="icofont-plus"></i></button></div><button
                                            class="standard-wish wish" title="Add to Wishlist"><i
