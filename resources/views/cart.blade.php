                ...
                <div class="col-lg-12">
                    <div class="account-card">
                        ...
                        <div class="account-content">
                                ...
                                <table class="table-list">
                                    ...
                                    @if(Session::has('cart'))
                                        ...
                                        <tr>
                                            ...
                                            <td class="table-image"><img src="{{ asset('images/product/'.$product['image'])}}" alt="product"></td>
                                            <td class="table-name">
                                                <h6>{{$product['name']}}</h6>
                                            </td>
                                            <td class="table-price">
                                                <h6>${{$product['price']}}<small>/kilo</small></h6>
                                            </td>
                                            ...
                                            <td class="table-action"><a class="view" href="#" title="Quick View"
                                                    ...
                                                    <form method="POST" action="{{ route('remove_from_cart')}}">
                                                        ...
                                                        <button type="submit" style="background:none; border:none" class="trash">
                            ...
                            @if(Session::has('cart'))
                                <ul>
                                    <li><span>Sub total</span><span>${{$product['price'] * $product['quantity']}}</span></li>
                                    <li><span>delivery fee</span><span>$10.00</span></li>
                                    <li><span>discount</span><span>$00.00</span></li>
                                    <li><span>Total<small>(Incl. VAT)</small></span><span>${{Session::get('total')}}</span></li>
                                </ul>
                             @endif
                            </div>
                        </div>
                ...
                <div class="col-lg-12">
                    <div class="account-card mb-0">
                        ...
                        <div class="account-content">
                            <div class="row">
                                <div class="col-md-6 col-lg-4 alert fade show">
                                    <div class="payment-card payment active"><img src="images/payment/png/01.png"
                                            alt="payment">
                                        <h4>card number</h4>
                                ...
                                <div class="col-md-6 col-lg-4 alert fade show">
                                    <div class="payment-card payment"><img src="images/payment/png/02.png"
                                            alt="payment">
                                        <h4>card number</h4>
                                        <p><span>****</span><span>****</span><span>****</span><sup>1876</sup></p>
                                        <h5>miron mahmud</h5><button class="trash icofont-ui-delete" title="Remove This"
                                ...
                                <div class="col-md-6 col-lg-4 alert fade show">
                                    <div class="payment-card payment"><img src="images/payment/png/03.png"
                                            alt="payment">
                                        <h4>card number</h4>
                                        <p><span>****</span><span>****</span><span>****</span><sup>1876</sup></p>
                                        <h5>miron mahmud</h5><button class="trash icofont-ui-delete" title="Remove This"
